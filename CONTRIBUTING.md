# Contributing to can-crud

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/canjs/can-crud) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-crud, you can start by going to its [fork page](https://github.com/canjs/can-crud/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-crud
```
